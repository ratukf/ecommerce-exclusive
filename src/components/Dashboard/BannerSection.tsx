      ...
      <Grid size={12}>
        <Box sx={{ position: 'relative', width: '100%' }}>
          ...
          >
            ...
            <Typography variant='h3'>Enhance Your Music Experience</Typography>
            {/* Countdown Timer */}
            <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
              <CountdownCircle value={days} label='Days' />
              <Typography variant='h5' sx={{ color: '#000', mx: 0.5, fontWeight: 700 }}>
                :
              </Typography>
