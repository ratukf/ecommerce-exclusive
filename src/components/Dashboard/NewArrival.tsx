...
import { NEW_ARRIVAL } from '../../shared/constants/newArrival';
...
const OverlayBox = ({ label, desc }: OverlayBoxProps) => (
  ...
  >
    ...
    <Button sx={{ padding: 0, textDecoration: 'underline' }}>Shop Now</Button>
  </Box>
);
...
export const NewArrival = () => (
  <Grid container spacing={2}>
    <Grid size={6} sx={{ position: 'relative' }}>
      <img
        src={NEW_ARRIVAL[0].src}
        alt={NEW_ARRIVAL[0].label}
